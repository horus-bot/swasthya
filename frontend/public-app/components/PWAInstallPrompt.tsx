    ...
    <div className="fixed left-1/2 -translate-x-1/2 bottom-6 z-50 max-w-[92%] sm:max-w-md">
      <div className="bg-white border shadow-lg rounded-xl p-3 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <img src="/logo.svg" alt="app" className="w-10 h-10 rounded-lg" />
          <div>
            <div className="text-sm font-semibold">Install Swasthya</div>
            <div className="text-xs text-slate-500">Quick access and offline support.</div>
          </div>
        </div>
        {!isIos ? (
