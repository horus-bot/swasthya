...
# Load dataset
# -----------------------------
df = pd.read_csv("synthetic_chennai_diarrhea_dataset.csv")
...
# Save Model
# -----------------------------
joblib.dump(le, "zone_encoder_diarrhea.pkl")
joblib.dump(model, "diarrhea_prediction_model.pkl")

print("\nModel saved as diarrhea_prediction_model.pkl")
